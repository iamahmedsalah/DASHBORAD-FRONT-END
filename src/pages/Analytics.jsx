    ...
    return (
        ...
        >
            ...
            >
                ...
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Analytics Page</h1>
                <p className="text-lg text-gray-600 mb-6">This page is currently under development. Stay tuned for updates!</p>
                <motion.button
                    initial={{ scale: 1 }}
                    whileHover={{ scale: 1.05 }}
                    className="px-6 py-3 bg-[#3B82F6] rounded-lg shadow hover:bg-primary-content  transition duration-300"
                >
                    <Link to="/">
                        Back to Dashboard
                    </Link>
